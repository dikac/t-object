...
describe('infinity',() =>{
    ...
    it(`positive`, () => {
        ...
        expect(Object({value:Infinity, valid:false})).toBe('type number is not object');
    });
...
describe('integer',() =>{
    ...
    it(`positive`, () => {
        ...
        expect(Object({value:1, valid:false})).toBe('type number is not object');
    });
...
describe('float',() =>{
    ...
    it(`float`, () => {
        ...
        expect(Object({value:1.1, valid:false})).toBe('type number is not object');
    });
...
describe('nan',() =>{
    ...
    it(`float`, () => {
        ...
        expect(Object({value:NaN, valid:false})).toBe('type number is not object');
    });
