...
//     let accessor = new Accessor(1);
//     let mutator = new Mutator(2);
//     let mixin = <Mutable<Accessor> & Mutator & Symbol_> Mixin(accessor, mutator, method);
//
//     it('default', () => {
//
...
describe('chain (symbol, method), (property, accessor), mutator', () => {
    ...
    let mutator = new Mutator(2);
    let mixin = <Mutable<Accessor> & Mutator & Symbol_ & Mutable<Method> & Property> Mixin(mutator, mixin2);

    // @ts-ignore
    console.log(Object.getPrototypeOf(mixin));
    console.log(mixin.getData());
    console.log(mixin.setData);
