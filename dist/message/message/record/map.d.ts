...
export default function Map<Instance extends Partial<Record<PropertyKey, Message>> = Partial<Record<PropertyKey, Message>>>(record: Instance): RecordInferPartial<Instance>;
