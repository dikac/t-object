 ...
 */
export default function Value<ObjectT extends object, Property extends keyof ObjectT, Type extends ObjectT[Property] = ObjectT[Property]>(object: ObjectT, property: Property, validation: (value: ObjectT[Property]) => value is Type): object is {
