...
interface ValueInterface<BaseT = unknown, ValueT extends BaseT = BaseT, MessageT = unknown, Container extends Record<any, Validator<BaseT, ValueT>> = Record<any, Validator<BaseT, ValueT>>, Validatable extends ValidatableInterface = ValidatableInterface> extends Validator<BaseT, ValueT, ValidatableValueCallback<BaseT, MessageT, Container, MapPartialUnion<MapReturn<Container>>, Validatable>> {
