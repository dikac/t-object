...
export default class Empty<MessageT> implements Validator<object, object, boolean, boolean, EmptyValidatable<object, MessageT>>, Message<Function<[Readonly<Value<object> & Validatable>], MessageT>> {
