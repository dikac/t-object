...
export default class Empty<MessageT> implements Validator<object, object, EmptyValidatable<object, MessageT>>, Message<Function<[Readonly<Value> & Readonly<Validatable>], MessageT>> {
