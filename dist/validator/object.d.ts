...
export default class Object_<MessageT> implements Validator<unknown, object, Readonly<Instance<object, MessageT>>>, Message<Function<[Readonly<Value> & Readonly<Validatable>], MessageT>> {
