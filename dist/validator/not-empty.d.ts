...
export default class NotEmpty<MessageT> implements Validator<object, object, boolean, boolean, NotEmptyValidatable<object, MessageT>>, Message<(result: Readonly<Value & Validatable>) => MessageT> {
