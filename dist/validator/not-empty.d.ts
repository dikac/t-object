...
export default class NotEmpty<MessageT> implements Validator<object, object, NotEmptyValidatable<object, MessageT>>, Message<Function<[Readonly<Value> & Readonly<Validatable>], MessageT>> {
