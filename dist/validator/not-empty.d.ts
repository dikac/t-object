...
export default class NotEmpty<MessageT> implements Validator<object, object, NotEmptyValidatable<MessageT>>, Message<Function<[Readonly<Value> & Readonly<Validatable>], MessageT>> {
