...
export declare type Interface<BaseT, ValueT extends BaseT, MessageT, RecordT extends Record<any, Validator<BaseT, ValueT>>, Result extends Record<any, Instance>, ValidatableT extends Validatable> = Validator<BaseT, ValueT, boolean, true, ValidatableValueCallbackInterface<BaseT, MessageT, RecordT, Result, ValidatableT>> & Validators<RecordT> & Message<Function<[Result], MessageT>> & Validation<Function<[Result], ValidatableT>>;
