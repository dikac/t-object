...
export default class Extract<O extends object, Key extends Object.Keys<O>[]> implements Readonly<Value<Omit<O, List.UnionOf<Key>>> & Return<Object.Pick<O, List.UnionOf<Key>>>> {
    readonly keys: Key;
