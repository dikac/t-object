...
import ValidateRecordKey from "./return/record/record-key";
...
) : Interface<BaseT, TypeT, ValidatorT, MapInterface<TypeT, ReturnInfer<ValidatorT>>, ValidatableT, MessageT> {
