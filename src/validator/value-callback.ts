...
export default class ValueCallback<
    ...
    MessageT = unknown,
    RecordT extends Record<PropertyKey, Validator<BaseT, ValueT>> = Record<PropertyKey, Validator<BaseT, ValueT>>,
    Result extends Record<PropertyKey, Validatable & Message & Value> = Record<PropertyKey, Validatable & Message & Value>,
